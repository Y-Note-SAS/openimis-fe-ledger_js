...
const initialState = {
  ...
  accountMutation: { submitting: false, error: null, lastMutationAt: null, mutation: null },
};
  ...
  switch (action.type) {
    ...
    case resp(ACTION_TYPE.DELETE_ACCOUNT): {
      ...
      if (message) {
        return {
          ...state,
          accountMutation: { ...state.accountMutation, submitting: false, error: message, mutation: null },
        };
      }
      return {
        ...state,
        accountMutation: {
          ...
          mutation: { ...state.accountMutation.mutation, id: result?.internalId ?? null },
        },
      };
    }
