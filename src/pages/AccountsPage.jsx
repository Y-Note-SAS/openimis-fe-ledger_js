...
const AccountsPage = ({
  ...
  useEffect(() => {
    ...
    // Feeds the core JournalDrawer: the mutation is shown in the mutation log
    // until the backend reports its final status.
    if (accountMutation.mutation) logMutation(accountMutation.mutation);
    setDialogOpen(false);
